        ...
        <div className="sk-panel-content view">
          ...
          { (!text) && ([
            <div className="note-content">
              ...
              <br></br>      
              Click <strong>Edit</strong> (<svg role="img" aria-label="Pencil icon to toggle edit mode" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            </svg>) at the top ⬆️ or <strong>Append</strong> at the bottom ⬇️ to add to your note. 📝
              <br></br><br></br>
              Click&nbsp;
              <svg role="button" aria-label="toggle show help" onClick={this.onToggleShowHelp} title="Help" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
