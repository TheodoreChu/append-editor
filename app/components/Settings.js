...
export default class Settings extends React.Component  {
  ...
  handleSubmit = () => {
    if (debugMode) {
      ...
      console.log(
        'Your useCodeMirror is: ' + this.state.useCodeMirror + "\n" +
        'Your chosen font for Edit/Append is: ' + fontEditMessage + "\n" +
        'Your chosen font for View/Print is: ' + fontViewMessage + "\n");
    }
    const {customStyles, fontEdit, fontSize, fontView, useCodeMirror} = this.state;
    this.props.onConfirm({customStyles}, {fontEdit}, {fontSize}, {fontView}, {useCodeMirror});
  }
  ...
  onKeyDown = (e) => {
    ...
    else if (this.props.keyMap.get('Control') && this.props.keyMap.get('Enter')) {
      e.preventDefault();
      this.handleSubmit();
    }
  }
  ...
  render () {
    ...
    <div tabIndex={0} className="sk-panel main settings" onBlur={this.onBlur}>
      <div className="sk-panel-content">
        ...
        <datalist id="fonts">, 
              <option value={"SFMono-Regular, Consolas, Liberation Mono, Menlo, \"Ubuntu Mono\", courier, monospace;"}/>
        ...
        <div className="sk-panel-row">
            ...
            <button onClick={this.clearAllSettings} title="Reset all Settings" id={resetAllSettingsID}>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M10.1812 7.66667C8.36883 7.66667 6.72741 8.33333 5.46214 9.4L3 7V13H9.15535L6.67953 10.5867C7.63019 9.81333 8.84074 9.33333 10.1812 9.33333C12.6023 9.33333 14.661 10.8733 15.3791 13L17 12.48C16.0493 9.68667 13.3615 7.66667 10.1812 7.66667Z" fill={"var(--sn-stylekit-foreground-color)"}/>
            </svg>
            </button>
            </div>
        </div>
        <section className="sk-panel-row settings">
          <div className="sk-h2">Enable in-line formatting: </div>
            ...
            <label>
              ...
              <button onClick={this.clearUseCodeMirror} title="Turn off in-line formatting">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M10.1812 7.66667C8.36883 7.66667 6.72741 8.33333 5.46214 9.4L3 7V13H9.15535L6.67953 10.5867C7.63019 9.81333 8.84074 9.33333 10.1812 9.33333C12.6023 9.33333 14.661 10.8733 15.3791 13L17 12.48C16.0493 9.68667 13.3615 7.66667 10.1812 7.66667Z" fill={"var(--sn-stylekit-foreground-color)"}/>
            </svg>
            </button>
        ...
        <section className="sk-panel-row settings">
          <div className="sk-h2"><label for={fontSizeID}>Choose a base font size: </label></div>
            <div>
              <input 
                list="fontSizes" 
                id={fontSizeID} 
                ...
                />
              <button onClick={this.clearFontSize} title="Reset font size to 16px">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M10.1812 7.66667C8.36883 7.66667 6.72741 8.33333 5.46214 9.4L3 7V13H9.15535L6.67953 10.5867C7.63019 9.81333 8.84074 9.33333 10.1812 9.33333C12.6023 9.33333 14.661 10.8733 15.3791 13L17 12.48C16.0493 9.68667 13.3615 7.66667 10.1812 7.66667Z" fill={"var(--sn-stylekit-foreground-color)"}/>
            </svg>
            </button>
